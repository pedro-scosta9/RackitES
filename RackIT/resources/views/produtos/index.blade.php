                            ...
                            @foreach ($produto as $prod)
                                ...
                                @php($val = 0)
                                    ...
                                    @foreach ($infoproduto as $infoprod)
                                        ...
                                        <td colspan="7" id="A{{ $prod->id }}"
                                            class="collapse table table-bordered table-condensed">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                            ...
                                                            @foreach ($infoproduto as $infoprod)
                                                                ...
                                                                <tr id="A{{ $prod->id }}" class="collapse">
                                                                    ...
                                                                    <td><a href="{{ route('produtos.deleteinfo', $infoprod->id) }}"
                                                                            type="button" class="text-danger font-weight-bold w-100"><i
                                                                                class="fa fa-trash" aria-hidden="true"> </i> Apagar</a></td>
