...
@section('page', 'Criar')
@section('content')
<a href="{{ route('armazens.index') }}" type="button" class="mt-0 mb-4 btn btn-primary"><i class="fa fa-arrow-left" aria-hidden="true"></i> Voltar
</a>
<h1>Inserir novo armazem</h1>
<form method="POST" action="{{ route('armazens.insert') }}">
    @csrf
    <div class="row">
